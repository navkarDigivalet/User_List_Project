...
class MyDatabase1(
    ...
    fun addUser(name:String , price : String , category: String)
    {
    ...
    fun readUser() : ArrayList<CourseModel>
    {
        ...
        {
            do{
                courseModelArrayList.add(CourseModel(cursorCourses.getString(0),cursorCourses.getString(1),cursorCourses.getString(2)))
    ...
    fun readCategory(category: String): ArrayList<CourseModel>
    {
        val db : SQLiteDatabase = this.readableDatabase
